...
class SearchTermTransferNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    public function normalize(mixed $object, string $format = null, array $context = []): array
    {
        ...
        return [
            ...
            'possible_types' => $object->getPossibleTypes() === null ? null : array_map(fn ($type) => $type->value, $object->getPossibleTypes()),
        ];
    }
    ...
    public function denormalize(mixed $data, string $type, string $format = null, array $context = []): SearchTermTransfer
    {
        ...
        $object
            ...
            ->setPossibleTypes(isset($data['possible_types']) ? array_map(fn ($type) => SearchTermType::from($type), $data['possible_types']) : null)
        ;
