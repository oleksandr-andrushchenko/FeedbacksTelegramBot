...
readonly class FeedbackSearchUserTelegramNotificationCreatedEvent
{
    private ?string $notificationId;

    public function __construct(
        ?string $notificationId = null,
        private ?FeedbackSearchUserTelegramNotification $notification = null,
    )
    {
    ...
    public function getNotification(): ?FeedbackSearchUserTelegramNotification
    {
