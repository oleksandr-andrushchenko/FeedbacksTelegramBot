...
use App\Entity\Lookup\UkraineCorrupt\UkraineCorruptPerson;
use App\Entity\Lookup\UkraineCorrupt\UkraineCorruptPersonsRecord;
 ...
 */
class UkraineCorruptLookupProcessor implements LookupProcessorInterface
{
    ...
    {
        return LookupProcessorName::ukraine_corrupts;
    }
