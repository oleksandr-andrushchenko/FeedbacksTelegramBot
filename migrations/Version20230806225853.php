 ...
 */
final class Version20230806225853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE telegram_conversations ADD bot VARCHAR(32) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE telegram_conversations DROP bot');
    }
}
